...
import com.noble.activity.RAZA_3.FindFriends.FindFriendsView.WebRTC.WebRTCWraper;
    ...
    private void setButton() {
        ...
        mCancenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RTCActivity.this, FindFriendsViewActivity.class);
